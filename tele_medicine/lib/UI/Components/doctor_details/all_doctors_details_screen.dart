...
class AllDoctorDetailsPage extends StatelessWidget {
  final AllDoctorsInfo all_doctor;
  const AllDoctorDetailsPage({Key? key,required this.all_doctor}) : super(key: key);
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: CircleAvatar(
                              backgroundImage: NetworkImage('${all_doctor.image}'),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text("${all_doctor.name}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.white),),
                              SizedBox(height: 5,),
                              Container(
                                  height: 60,
                                  width: 200,
                                  child: Text("${all_doctor.degree}",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white38))),
                              Text("${all_doctor.department}",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white))
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 2,),
                                  Text("${all_doctor.experience} YEARS",
                                    style: TextStyle(
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("${all_doctor.institue}",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(" ৳${all_doctor.fee}",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.blue)),
                          ),
                        ],
                      ),
                    ),
