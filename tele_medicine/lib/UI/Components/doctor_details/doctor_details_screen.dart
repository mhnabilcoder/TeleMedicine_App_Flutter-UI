                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text("${doctor.name}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.white),),
                              SizedBox(height: 5,),
                              Container(
                                height: 60,
                                width: 200,
                                  child: Text("${doctor.degree}",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white38))),
                              Text("${doctor.department}",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white))
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("${doctor.institue}",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(" ৳${doctor.fee}",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.blue)),
                          ),
                        ],
                      ),
                    ),
